...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-appengine-0.0.7/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-apis-0.0.13/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/json-jruby-1.2.4-universal-java-1.6/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_dm_datastore-0.2.8/lib")
