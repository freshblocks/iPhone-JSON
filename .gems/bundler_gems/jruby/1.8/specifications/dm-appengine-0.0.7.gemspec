...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.rdoc", "Rakefile", "spec/dm-appengine_spec.rb", "spec/spec_helper.rb", "lib/appengine_adapter.rb", "lib/dm-appengine/types.rb"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<appengine-apis>, ["~> 0.0.12"])
      s.add_runtime_dependency(%q<dm-core>, ["= 0.10.2"])
    else
      s.add_dependency(%q<appengine-apis>, ["~> 0.0.12"])
